...
def train(input_batches, input_lengths, target_batches, target_lengths, encoder, decoder, encoder_optimizer, decoder_optimizer, criterion, max_length=MAX_LENGTH):
    ...
    print(target_batches.transpose(0, 1).contiguous())
...
def optimized_evaluate(test_pairs,check):
    ...
    if best_F1 < f1_score:
        torch.save(encoder.state_dict(),'best_encoder_original')
        torch.save(decoder.state_dict(),'best_decoder_original')
        best_F1 = f1_score
...
encoder.load_state_dict(torch.load('best_encoder_original'))
decoder.load_state_dict(torch.load('best_decoder_original'))
